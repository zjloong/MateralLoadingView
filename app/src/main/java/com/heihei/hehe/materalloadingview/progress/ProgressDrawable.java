...
public class ProgressDrawable extends Drawable implements Animatable {
    ...
    private final ProgressDrawable.Ring mRing;
    ...
    public ProgressDrawable(Context context, View parent) {
        ...
        mRing = new ProgressDrawable.Ring(mCallback);
    ...
    private void setSizeParameters(double progressCircleWidth, double progressCircleHeight,
        ...
        final ProgressDrawable.Ring ring = mRing;
     ...
     */
    public void updateSizes(@ProgressDrawable.ProgressDrawableSize int size) {
        if (size == LARGE) {
    ...
    float getMinProgressArc(ProgressDrawable.Ring ring) {
     ...
     * the next color.
     */
    void updateRingColor(float interpolatedTime, ProgressDrawable.Ring ring) {
    ...
    void applyFinishTranslation(float interpolatedTime, ProgressDrawable.Ring ring) {
